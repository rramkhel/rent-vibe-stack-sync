/**
 * Classification Examples Data
 * Extracted from classification-examples.jsx
 * 11 examples across 5 categories
 */
...
var categoryColors = {
    'Rentals.ca': { bg: 'blue', border: 'blue', text: 'blue' },
    'RentSync/BSTK': { bg: 'emerald', border: 'emerald', text: 'emerald' },
    'Spacelist': { bg: 'orange', border: 'orange', text: 'orange' },
    'WoodCabins': { bg: 'amber', border: 'amber', text: 'amber' },
    'Edge Case': { bg: 'purple', border: 'purple', text: 'purple' }
};
